describe('logic - retrieve duck', () => {
    ...
    it('should fail on incorrect id or expression types', () => {
        ...
        expect(() => { retrieveDuck(id, token, 'red', 1) }).to.throw(TypeError, '1 is not a function')
        expect(() => { retrieveDuck(id, token, 'red', true) }).to.throw(TypeError, 'true is not a function')
        expect(() => { retrieveDuck(id, token, 'red', []) }).to.throw(TypeError, ' is not a function')
        expect(() => { retrieveDuck(id, token, 'red', {}) }).to.throw(TypeError, '[object Object] is not a function')
        expect(() => { retrieveDuck(id, token, 'red', undefined) }).to.throw(TypeError, 'undefined is not a function')
        expect(() => { retrieveDuck(id, token, 'red', null) }).to.throw(TypeError, 'null is not a function')
    })
})