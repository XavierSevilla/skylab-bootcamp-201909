describe('logic - search ducks', () => {
    ...
    it('should fail on incorrect criteria', done => {
        ...
        searchDucks(id, token, query, (error, ducks) => {
            ...
            expect(error.message.length).to.be.at.least(1)
