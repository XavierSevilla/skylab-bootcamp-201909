...
module.exports = function ({ path, query, name, logout, favorites, error, results, favPath, detail, titulo }) {
    ...
    ${results ? Results({ items: results, onItemRender: duck => ResultItem({ item: duck, favPath, detail}), titulo }) : ''}
</section>`
}