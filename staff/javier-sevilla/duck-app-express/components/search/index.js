...
module.exports = function ({ path, query, name, logout, error, results, favPath, detail, onBack }) {
    ...
    ${results ? Results({ items: results, onItemRender: duck => ResultItem({ item: duck, favPath, detail }) }) : ''}
</section>`
}