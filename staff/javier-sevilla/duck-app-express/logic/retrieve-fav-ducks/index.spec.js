...
describe('when favs already exists', () => {
    ...
    it('should fail on incorrect user data or expression types', () => {
        ...
        expect(() => { retrieveFavDucks(id, token, 1) }).to.throw(TypeError, '1 is not a function')
        expect(() => { retrieveFavDucks(id, token, true) }).to.throw(TypeError, 'true is not a function')
        expect(() => { retrieveFavDucks(id, token, []) }).to.throw(TypeError, ' is not a function')
        expect(() => { retrieveFavDucks(id, token, {}) }).to.throw(TypeError, '[object Object] is not a function')
        expect(() => { retrieveFavDucks(id, token, undefined) }).to.throw(TypeError, 'undefined is not a function')
        expect(() => { retrieveFavDucks(id, token, null) }).to.throw(TypeError, 'null is not a function')
    })
})